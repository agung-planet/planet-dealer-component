 ...
 *
 * @param state The [DealerPullRefreshState] associated with this pull-to-refresh component.
 * The state will be updated by this modifier.
 * @param enabled If not enabled, all scroll delta and fling velocity will be ignored.
 */
fun Modifier.dealerPullRefresh(
    ...
    Modifier.dealerPullRefresh(state::onPull, state::onRelease, enabled)
}
